...
import { SaleSaveRequest } from "../../APIRequest/SaleAPIRequest";
import { CustomerDropDownRequest } from "../../APIRequest/SaleAPIRequest";
import { ProductDropDownRequest } from "../../APIRequest/SaleAPIRequest";
...
const SalesCreateUpdate = () => {
  ...
  const CreateNewSale = async () => {
    // Apply Validation
    const res = await SaleSaveRequest(SaleFormValue, SaleItemList);
  };
